...
public class MercadoController {
	...
	public ModelAndView adicionar() {
		...
		result.addObject("mercado", new Market());
		return result;
	}
	
	@PostMapping("/add")
	public String adicionar(Market mercado) {
	...
	public ModelAndView editar(@PathVariable Long id) {
		Market mercado = repositorioMercado.getOne(id);
	...
	@PostMapping("/edit")
	public String editar(Market mercado) {
		repositorioMercado.save(mercado);
		return "redirect:/methods/index";
	}
